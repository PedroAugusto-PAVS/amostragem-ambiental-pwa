...
async function imprimirFichaMedicao(medicaoLocalId) {
  ...
  center("FICHA DE CAMPO", 35, y + 15, 115, fontes.titulo, true);
  txt("REN-AMS-009", 154, y + 6.5, fontes.metadado, true);
  txt("Rev: 00", 154, y + 12.5, fontes.metadado);
  txt("REFERÊNCIA: POP 139", 154, y + 18.5, fontes.metadado);
  ...
  txt("Responsável ALS:", 12, y + 25, fontes.rodape, true);
  line(48, y + 25, 95, y + 25);
  txt("Assinatura", 50, y + 32, fontes.rodape);

  txt("Responsável Cliente:", 110, y + 25, fontes.rodape, true);
