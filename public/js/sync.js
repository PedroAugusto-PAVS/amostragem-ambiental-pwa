...
async function imprimirFichaMedicao(medicaoLocalId) {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    txt(i === 0 ? texto(medicao.nivel_agua) : "", 33, y + 5, 6);
